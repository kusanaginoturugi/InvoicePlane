...
<header class="clearfix">
	...
	<br/>
        ...
        if ($quote->client_zip) {
            echo '<div>' . htmlsc($quote->client_zip) . '</div>';
        }
        if ($quote->client_state || $quote->client_city || $quote->client_address_2) {
            echo '<div>';
	...
	<br/>
        ...
        if ($quote->user_zip) {
            echo '<div>' . htmlsc($quote->user_zip) . '</div>';
        }
	
        if ($quote->user_city || $quote->user_state || $quote->user_zip || $quote->user_address_2) {
            echo '<div>';
            if ($quote->user_state) {
...
<main>
    ...
    <div class="invoice-details clearfix">
        <table>
            ...
            <tr>
                ...
                <td><?php echo format_jpy_pdf_currency($quote->quote_total); ?></td>
            </tr>
        </table>
    </div>
    ...
    <table class="item-table">
        ...
        <tr>
            ...
            <td class="text-right"><?php echo format_jpy_pdf_currency($quote->quote_item_subtotal); ?></td>
        </tr>
        ...
        <?php if ($quote->quote_item_tax_total > 0) { ?>
            <tr>
                ...
                <td class="text-right">
                    <?php echo format_jpy_pdf_currency($quote->quote_item_tax_total); ?>
                </td>
            </tr>
        <?php } ?>
        ...
        <?php foreach ($quote_tax_rates as $quote_tax_rate) : ?>
            <tr>
                ...
                <td class="text-right">
                    <?php echo format_jpy_pdf_currency($quote_tax_rate->quote_tax_rate_amount); ?>
                </td>
            </tr>
        <?php endforeach ?>
        ...
        <?php if ($quote->quote_discount_amount != '0.00') : ?>
            <tr>
                ...
                <td class="text-right">
                    <?php echo format_jpy_pdf_currency($quote->quote_discount_amount); ?>
                </td>
            </tr>
        <?php endif; ?>
        ...
        <tr>
            ...
            <td class="text-right">
                <b><?php echo format_jpy_pdf_currency($quote->quote_total); ?></b>
            </td>
        </tr>
        </tbody>
    </table>
